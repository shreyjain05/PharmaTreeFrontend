...
const SearchScreen = () => {
    ...
    const handleProductSelect = (item) => {
        ...
        // Navigate to the ProductDescriptionScreen with the selected product
        ...
        // Update search text with the selected product name
                ...
                {filteredProducts.length > 0 && (
                    <View style={styles.dropdown}>
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <TouchableOpacity style={styles.dropdownItem} onPress={() => handleProductSelect(item)} >
