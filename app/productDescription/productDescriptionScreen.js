...
const ProductDescriptionScreen = () => {
    ...
    console.log("user information in description: " + JSON.stringify(loggedInUser))
  ...
  const onBuyItem = (item, product) => {
    ...
    setShoppingList((prevShoppingList) => {
        ...
        if (existingProduct) {
          ...
          console.log("Updated Quantity for:", product.id, "Batch:", item.batchNumber);
  ...
  const onAddItemToWishList = async (userData, product) => {
    ...
    console.log("set target paylaod", userData);
        try {
            ...
            if (!updateResponse.ok) throw new Error("Failed to update customer metadata");
        ...
        {Object.entries(fieldIcons).map(([key, field]) => {
            ...
            return (
                ...
                >
                    ...
                    >
                        <FontAwesome name={field.icon} size={20} color={Colors.companyPrimaryDark} />
                    </View>
    ...
    {isInventorySelected && (
        <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between", gap: 10 }}>
            ...
            >
                ...
                <Text style={{ color: Colors.whiteColor, fontSize: 16, fontWeight: "bold" }}>Buy Now</Text>
            </TouchableOpacity>
            ...
            >
                ...
                <Text style={{ color: Colors.companyPrimaryDark, fontSize: 16, fontWeight: "bold" }}>Add to Cart</Text>
            </TouchableOpacity>
            ...
            >
                <FontAwesome name="heart" size={20} color={Colors.companyPrimaryDark} style={{ marginRight: 8 }} />
                <Text style={{ color: Colors.companyPrimaryDark, fontSize: 16, fontWeight: "bold" }}>Wishlist</Text>
            </TouchableOpacity>
        </View>
    )}
    </View>
                ...
                >
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 10 }}>
                        <View style={{
                            ...
                            <FontAwesome5 name="rupee-sign" size={16} color={Colors.companyPrimaryDark} />
                        </View>
                        <Text style={{
                            fontSize: 14,
                            color: Colors.grayColor,
