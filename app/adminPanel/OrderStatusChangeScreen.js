    ...
    const handleSubmit = (orderId) => {
      ...
      const fetchOrders = async () => {
        try {
          ...
          Alert.alert("Status Updated", `Order ${updatedOrder.orderID} is now ${updatedOrder.status}`);
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "white" }}>
            <View style={{ flex: 1 }}>
                ...
                <Card style={{ padding: 5, borderRadius: 20, elevation: 5, backgroundColor: "#FFFFFF", margin:10 }}>
                <Text style={{ fontSize: 22, fontWeight: "bold", color: "#10857F", marginBottom: 5, textAlign: "center" }}>📅 Order Status Change</Text>
...
<FlatList
                     ...
                     renderItem={({ item }) => (
                         <View style={{ padding: 15, borderBottomWidth: 1, borderBottomColor: "#ddd", backgroundColor: "#FFFFFF", borderRadius: 10, margin: 10 }}>
                             <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                                 <FontAwesome name="list-alt" size={24} color="#4CAF50" style={{ marginRight: 10 }} />
                                 <View style={{ flex: 1 }}>
                                     <Text style={{ fontSize: 18, fontWeight: "bold", color: "#333" }}>Order: {item.orderID}</Text>
                             ...
                             <Picker
                                 ...
                                 style={{ height: 40, width: "100%", backgroundColor: "#FFFFFF", borderRadius: 10, marginVertical: 10 }}
