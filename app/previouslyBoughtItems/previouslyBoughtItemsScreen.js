        ...
        <TouchableWithoutFeedback>
          <View style={styles.selectQuantityModelStyle}>
            ...
            >
              ...
              >
                {itemsList[currentItemIndex].qty == 0 ? null : (
                  <Text
                    style={{
            ...
            >
              <View style={{ flexDirection: "row" }}>
                ...
                <View style={{ marginLeft: Sizes.fixPadding }}>
                  ...
                  <Text
                    style={{ ...Fonts.primaryColor18Regular, lineHeight: 23.0 }}
                  >
    ...
    return (
      <View style={styles.deliverToInfoWrapStyle}>
        <View style={{ flexDirection: "row" }}>
          ...
          />
          <View style={{ marginLeft: Sizes.fixPadding }}>
            <Text style={{ ...Fonts.primaryColor15Light }}>Deliver To</Text>
        ...
        >
          <Text
            style={{ ...Fonts.primaryColor18Medium, alignSelf: "flex-end" }}
          >
            Change
          </Text>
        </TouchableOpacity>
